...
public interface CatalogValueService extends DataService<CatalogValue, UUID, CatalogValueDto, CatalogValueDto> {
    CatalogValueDto findByCatalogCodeAndCode(@NonNull String catalogCode, @NonNull String code);
}
